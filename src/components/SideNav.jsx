  ...
  return (
    <Fragment>
      ...
      <nav className="app__side-nav nav">
        ...
        <NavItem>
          <NavLink exact to="/tasks" className="nav__link link" activeClassName="link_active" onClick={handleToggle}>
            <img src={TasksIcon} alt="task" className="link__icon" />
            <span className="link__text">All Tasks</span>
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink to="/tasks/pending" className="nav__link link" activeClassName="link_active" onClick={handleToggle}>
            <img src={TaskPendingIcon} alt="task" className="link__icon" />
            <span className="link__text">Pending</span>
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink to="/tasks/in-progress" className="nav__link link" activeClassName="link_active" onClick={handleToggle}>
            <img src={TaskInProgressIcon} alt="task" className="link__icon" />
            <span className="link__text">In Progress</span>
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink to="/tasks/completed" className="nav__link link" activeClassName="link_active" onClick={handleToggle}>
            <img src={TaskCompleteIcon} alt="task" className="link__icon" />
            <span className="link__text">Completed</span>
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink to="/tasks/archived" className="nav__link link" activeClassName="link_active" onClick={handleToggle}>
